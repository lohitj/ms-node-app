node {
   ...
   stage("Checkout Source"){
       checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/lohitj/ms-node-app.git']]])
   }
   ...
   */
   ...
   stage("Prod - Deploying Application"){
       openshiftDeploy(namespace:'ms-prod-kt', deploymentConfig: 'front-end')
   }
